...
var modes;
(function (modes) {
    modes[modes["line"] = 0] = "line";
    modes[modes["erase"] = 1] = "erase";
    modes[modes["rectFill"] = 2] = "rectFill";
    modes[modes["rectStroke"] = 3] = "rectStroke";
    modes[modes["circleFill"] = 4] = "circleFill";
    modes[modes["circleStroke"] = 5] = "circleStroke";
})(modes || (modes = {}));
let mode = modes.line;
let prevX;
let prevY;
